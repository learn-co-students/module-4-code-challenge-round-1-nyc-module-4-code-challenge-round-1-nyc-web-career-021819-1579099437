...
[X] ### 3.  Enlisting and Discharging bots

Once the list is complete, work on the functionality of enlisting bots into your army.

  [X] Clicking a card should add a bot to the user's list of bots. Bots that have been chosen should be displayed within `YourBotArmy`, which should also be a child of `BotsPage`  (feel free to reuse `BotCard`).

  [X] _A bot should be enlisted only once_.

  [X] If you click on a bot in your army, **that bot should be removed from your army**.
